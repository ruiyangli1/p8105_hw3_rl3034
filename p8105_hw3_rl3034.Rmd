...
This tidied accelerometer dataset contains `r nrow(accel_df)` observations and `r ncol(accel_df)` variables. These variables include week, day, hour, minute and activity counts for each minute of a 24-hour day starting at midnight. 
...
* Here is a single-panel plot that shows the 24-hour activity time courses for each day, colored by day of the week. Based on this graph, it can be seen that Sunday has more activities in the middle of the day; Thursday has more activities around 6am. Monday, Wednesday, Friday and Saturday have more activities close to the end of the day; activities are the lowest at the beginning and the end of a day. 
